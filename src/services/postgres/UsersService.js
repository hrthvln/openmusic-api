// Service untuk interaksi dengan database PostgreSQL untuk tabel user.
...
class UsersService {
  ...
  // Memverifikasi username baru (harus unik)
  ...
  // Memverifikasi keberadaan user berdasarkan ID (untuk kolaborasi)
